...
export class GridsterRenderer {
  ...
  updateItem(el: Element, item: GridsterItem, renderer: Renderer): void {
  ...
  clearCellPosition(renderer: Renderer, el: Element): void {
    if (this.gridster.$options.useTransformPositioning) {
  ...
  setCellPosition(renderer: Renderer, el: Element, x: number, y: number): void {
